...
# you can create / list / drop /  insert into / select from / delete from spacefice table
function list2() {
    select choice in "create-table" "list-table" "drop-table" "insert-in-table" "select-from-table" "delete-from-table"; do
        case $choice in
        create-table)
